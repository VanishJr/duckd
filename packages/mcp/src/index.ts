 ...
 *    one session store.
 *
 * The tool surface is intentionally narrow. The duck's value is a constraint —
 * it withholds the answer — and every extra tool is another way for a host agent
 * to route around that constraint.
 */
